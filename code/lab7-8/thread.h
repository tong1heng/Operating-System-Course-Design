...
// while executing kernel code.
  ...
  public:
    ...
    void Terminated();
    int GetSpaceId() { return space->GetSpaceId(); }
    int GetWaitProcessSpaceId() { return waitProcessSpaceId; }

    int GetExitCode() { return exitCode; }
    void SetExitCode(int code) { exitCode = code; }
    
    int GetWaitProcessExitCode() { return waitProcessExitCode; }
    void SetWaitProcessExitCode(int code) { waitProcessExitCode = code; }

    AddrSpace *space;			// User code this thread is running.
    
    unsigned int fatherProcessSpaceId;
    unsigned int childProcessSpaceId[MaxChildProcess];
